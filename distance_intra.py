...
for LETTER_COLOUR, TRANSPARENT, SUFFIX in PLOT_STYLES:
    ...
    hist(axes[0,0], intra_NH, mlabel(r"N$-$H (bonded)", intra_NH), "steelblue", LETTER_COLOUR, stat="count")
    axes[0,0].set_title(r"N$-$H of urea")
    ...
    axes[0,1].set_title(r"CH$_2$$-$CH$_2$")
    ...
    hist(axes[1,0], intra_CH_N, mlabel(r"CH$_2$$-$N", intra_CH_N), "seagreen", LETTER_COLOUR, stat="count")
    hist(axes[1,0], intra_CH_O, mlabel(r"CH$_2$$-$O", intra_CH_O), "purple", LETTER_COLOUR, stat="count")
    axes[1,0].set_title(r"C$-$H of each CH$_2$")
    ...
    hist(axes[1,1], intra_CH_urea, mlabel(r"C$-$H", intra_CH_urea), "indianred", LETTER_COLOUR, stat="count")
    axes[1,1].set_title(r"C$-$H of urea")
    ...
    ax.set_title(r"N$-$H of urea: bonded vs all")
